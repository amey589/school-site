...
@app.route("/services")
def services():
    return render_template('services.html', my_string="FooBar"
        , my_list=[18,19,20,21,22,23], title="Contact Us", current_time=datetime.datetime.now())

@app.route("/calender")
def calender():
    return render_template('calender.html', my_string="FooBar"
        , my_list=[18,19,20,21,22,23], title="Contact Us", current_time=datetime.datetime.now())

@app.route("/gallery")
def gallery():
    return render_template('gallery.html', my_string="FooBar"
        , my_list=[18,19,20,21,22,23], title="Contact Us", current_time=datetime.datetime.now())

@app.route("/news")
def news():
    return render_template('news.html', my_string="FooBar"
        , my_list=[18,19,20,21,22,23], title="Contact Us", current_time=datetime.datetime.now())
